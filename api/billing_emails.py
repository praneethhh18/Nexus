...
def send_trial_started(
    *,
    ...
    body = (
        ...
        f"When you are ready to continue, open /pricing and contact us. "
        f"We will discuss the right plan before any payment.\n\n"
    ...
    *,
    ...
    if days_remaining >= 7:
        ...
        body = (
            ...
            f"ends in 3 days.\n\n"
            f"If you'd like to keep going, contact us from:\n"
            f"  → {_app_url()}/pricing\n\n"
            f"We will discuss the right plan, onboarding, and billing before "
            f"any payment.\n\n"
...
def send_trial_expired(
    *,
    ...
    body = (
        ...
        f"  • Pro features lock until we move you to a paid or custom plan\n\n"
        f"Want to keep Pro?\n"
        f"  → {_app_url()}/pricing\n\n"
